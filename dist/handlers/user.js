    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, UserStoreInstance.create({ firstname: firstname, lastname: lastname, username: username, password: password })];
            case 1:
                user = _a.sent();
                res.json(helpers_1.getTokenByUser(user));
                return [3 /*break*/, 3];
            case 2:
                e_2 = _a.sent();
                res.status(400);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, UserStoreInstance.read(id)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, UserStoreInstance.update(id, { firstname: firstname, lastname: lastname })];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
