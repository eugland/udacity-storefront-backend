...
var OrderStoreInstance = new order_1.OrderStore();
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, OrderStoreInstance.index()];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (products === undefined || status_1 === undefined || user_id === undefined) {
                    res.status(400);
                    res.send("Some required parameters are missing! eg. :products, :status, :user_id");
                    return [2 /*return*/, false];
                }
                return [4 /*yield*/, OrderStoreInstance.create({ products: products, status: status_1, user_id: user_id })];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, OrderStoreInstance.read(id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                user_id = req.body.user_id;
                if (products === undefined || status_2 === undefined || user_id === undefined || id === undefined) {
                    res.status(400);
                    res.send("Some required parameters are missing! eg. :products, :status, :user_id, :id");
                    return [2 /*return*/, false];
                }
                return [4 /*yield*/, OrderStoreInstance.update(id, { products: products, status: status_2, user_id: user_id })];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, OrderStoreInstance.deleteOrder(id)];
            case 1:
                _a.sent();
